...
# data/court18-22/fulltext/criminal_first.csv
# data/court18-22/allcases/criminal_first.csv
...
filename <- paste0(
  "data/court18-22/", filetype, "/criminal_first.csv"
)
output_filename <- paste0(
  "data/court18-22/", filetype, "/final_estimates/criminal_first_transparency.csv"
)
ksfilename_mvue <- paste0(
  "data/court18-22/", filetype, "/final_estimates/criminal_first_ks_test_mvue.csv"
)
ksfilename_coarsen <- paste0(
  "data/court18-22/", filetype, "/final_estimates/criminal_first_ks_test_coarsen.csv"
)
# Load data
dataset <- read.csv(
  file = filename,
