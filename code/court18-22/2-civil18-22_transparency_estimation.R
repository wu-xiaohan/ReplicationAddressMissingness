# This file contains replication code for estimating transparency in civil
...
# data/court18-22/fulltext/civil_first_2018.csv
# data/court18-22/fulltext/civil_first_2019.csv
# data/court18-22/fulltext/civil_first_2020.csv
# data/court18-22/fulltext/civil_first_2021.csv
# data/court18-22/fulltext/civil_first_2022.csv
# data/court18-22/allcases/civil_first_2018.csv
# data/court18-22/allcases/civil_first_2019.csv
# data/court18-22/allcases/civil_first_2020.csv
# data/court18-22/allcases/civil_first_2021.csv
# data/court18-22/allcases/civil_first_2022.csv

# This code uses cases from the year 2018 as an example.

filetype <- "fulltext" # "fulltext" or "allcases"
fileyear <- "2022" # "2018", "2019", "2020", "2021", or "2022"

filename <- paste0(
  "data/court18-22/", filetype, "/civil_first_", fileyear, ".csv"
)
output_filename <- paste0(
  "data/court18-22/", filetype, "/final_estimates/civil_first_",
  fileyear, "_transparency.csv"
)
ksfilename_mvue <- paste0(
  "data/court18-22/", filetype, "/final_estimates/civil_first_",
  fileyear, "_ks_test_mvue.csv"
)
ksfilename_coarsen <- paste0(
  "data/court18-22/", filetype, "/final_estimates/civil_first_",
  fileyear, "_ks_test_coarsen.csv"
)
# Load data
dataset <- read.csv(
  file = filename,
...
data_clean <- function(dataset) {
  ...
  pattern <- "\\d*"
  dataset$clean_case_number <- ifelse(
    grepl(pattern, dataset$case_number_id),
    regmatches(
      dataset$case_number_id,
      regexpr(pattern, dataset$case_number_id)
    ),
    NA
  )
  pattern <- "0*"
