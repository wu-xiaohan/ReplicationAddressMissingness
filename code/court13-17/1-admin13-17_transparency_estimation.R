...
# data/court13-17/raw_data/admin_litigation.csv

library(lmtest)
# load data
initial_data = read.csv('/Users/wuxiaohan/Dropbox/Research/TTD-replication_final/data/court13-17/raw_data/admin_litigation.csv')
...
write.csv(processedDataSave,'data/court13-17/temp_file_for_ttd/admin13-17-all.csv') 
...
write.csv(processedDataSave,'data/court13-17/temp_file_for_ttd/admin13-17temp.csv') 
...
write.csv(criminal,'data/court13-17/final_estimates/admin_transparency_final.csv')
