...
# The code can also run on data/court13-17/temp_file_for_ttd/admin13-17-all.csv

# Load data
GTS = read.csv('data/court13-17/temp_file_for_ttd/criminal13-17-all.csv')

GTS$adjust_startdate = as.numeric(as.character(GTS$adjust_startdate))

input_data = read.csv('data/court13-17/temp_file_for_ttd/criminal13-17temp.csv')
...
write.csv(final_pred,'/Users/wuxiaohan/Dropbox/Research/TTD-replication_final/data/court13-17/final_estimates/criminalTTDpred.csv')
