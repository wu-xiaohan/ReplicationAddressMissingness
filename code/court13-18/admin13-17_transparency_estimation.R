...
# data/court13-18/raw_data/admin_litigation.csv

library(lmtest)
# load data
initial_data = read.csv('/Users/wuxiaohan/Dropbox/Research/TTD-replication_final/data/court13-18/raw_data/admin_litigation.csv')
...
processedDataSave = subset(processedData,court_division == '行初')
...
write.csv(processedDataSave,'data/court13-18/temp_file_for_ttd/admin13-18-all.csv') 
...
write.csv(processedDataSave,'data/court13-18/temp_file_for_ttd/admin13-18temp.csv') 
...
admin = subset(admin,est_total<15000) # none thrown out
admin$availability = admin$case_in_division/admin$est_total

write.csv(criminal,'data/court13-18/final_estimates/admin_transparency_final.csv')
