...
# data/court13-18/raw_data/criminal_litigation.csv


# load data
initial_data = read.csv('data/court13-18/raw_data/criminal_litigation.csv')
...
write.csv(processedDataSave,'data/court13-18/temp_file_for_ttd/criminal13-18-all.csv') 
...
write.csv(processedDataSave,'data/court13-18/temp_file_for_ttd/criminal13-18temp.csv') 
...
write.csv(criminal,'data/court13-18/final_estimates/criminal_transparency_final.csv')
